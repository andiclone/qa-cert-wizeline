# This project is an intro to TestCafe using NPM
...
You will also need to create a **.env** file in your root project dir with the variables used in Constants.js  
